...
int val; 
int ChaveEsquerda=2; //Pino a ser ligado na chave esquerda
int ChaveCentral=1;  //Pino a ser ligado na chave central
int ChaveDireita=3;  //Pino a ser ligado na chave direita
...
{ 
 ...
 val=digitalRead(ChaveDireita);
   if(val!=1)
    {
       myservo.write(+90);  //Move o servo para o angulo de 120 graus
       delay(15);
    }
}
