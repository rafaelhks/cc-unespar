...
public class Pixel {
    ...
    public boolean matchColor(Pixel p, int tolerance){
        return p.getHSV()[0]==this.getHSV()[0] || 
               (p.getHSV()[0]>this.getHSV()[0]-tolerance && p.getHSV()[0]<this.getHSV()[0]+tolerance);
    }
    
    public boolean matchColor(double[] inRGB){
        return inRGB[0]==this.RGB[0] && inRGB[1]==this.RGB[1] && inRGB[2]==this.RGB[2];
    }
