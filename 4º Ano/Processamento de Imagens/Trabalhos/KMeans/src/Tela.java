...
public class Tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PrincipalLayout.setVerticalGroup(
            ...
            .addGroup(PrincipalLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblPictureScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 469, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        preencherCentro.setText("K-Means");
    ...
    private void preencherCentroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_preencherCentroActionPerformed
        if(image!=null){
            KMeans km = new KMeans(image, 15);
            System.out.println("Iniciando separação dos grupos.");
            km.execute();
            System.out.println("\nSeparação em grupos finalizada!");
            setDisplayImage(km.getResultImage(), lblPicture);
        }
