...
public class Tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        numTextArea = new javax.swing.JTextArea();
        ...
        numTextArea.setBackground(new java.awt.Color(51, 51, 51));
        numTextArea.setColumns(20);
        numTextArea.setForeground(new java.awt.Color(0, 204, 0));
        numTextArea.setRows(5);
        jScrollPane1.setViewportView(numTextArea);
        ...
        PrincipalLayout.setHorizontalGroup(
            ...
            .addGroup(PrincipalLayout.createSequentialGroup()
                ...
                .addGroup(PrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblPictureScrollPane, javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        PrincipalLayout.setVerticalGroup(
            ...
            .addGroup(PrincipalLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblPictureScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 467, Short.MAX_VALUE)
    ...
    private void preencherCentroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_preencherCentroActionPerformed
        if(image!=null){
            String n = imgProc.Cadeia(image, 0, 0, new double[]{0,0,255});
            setDisplayImage(image, lblPicture);
            numTextArea.setText(n);
        }
    ...
    private javax.swing.JTextArea numTextArea;
