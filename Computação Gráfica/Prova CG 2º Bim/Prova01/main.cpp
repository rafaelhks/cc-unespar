...
GLfloat lightX = 0, lightY = 10, lightZ = 0;
...
void menu(){
    ...
    cout<<"Setas do teclado movimentam a luz"<<endl;
}
...
void Keyboard(unsigned char key, int x, int y){
    ...
    else if(key==GLUT_KEY_LEFT) lightX++;
...
void init(){
    ...
    glutCreateWindow("Computação Gráfica - Prova 2º Bimestre - Exercício 01 - Rafael Francisco Ferreira"); //Cria a janela
