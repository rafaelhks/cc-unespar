...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PrincipalLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PrincipalLayout.createSequentialGroup()
                ...
                .addComponent(lblAngle, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void rotateSliderMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rotateSliderMouseReleased
        if(rotateSlider.isEnabled()){
            ...
            setDisplayImage(imgProc.MatToBuffImg(imgProc.Rotate(angulo)));
        }
